...
📊 **Dashboard Demo:**  
[demo video link](https://youtu.be/JCvjSIs3CaY)
...
🔑 **Key Highlights:**  
- Created a labeled dataset with both structured features (e.g., GPA, sleep hours) and emotion vectors extracted from self-reported reflections.  
- Evaluated several supervised learning models (Random Forest, XGBoost, Logistic Regression) for multi-class classification of mental health status.  
- Achieved a 68% accuracy score with the best-performing model.  
- Conducted feature importance analysis, revealing the most influential factors, such as GPA, emotions (anticipation, sadness), and behavioral factors (sleeping hours, steps per day).

📊 **Methodologies:**  
- Used NLP techniques (NRCLex) to extract emotions from free-text reflections.  
- Normalized features using StandardScaler and encoded categorical data with LabelEncoder.  
- Applied multiple classification models, with hyperparameter tuning and cross-validation, selecting the best-performing model based on F1-score and AUC.  
- Interpreted feature importance using SHAP for transparency and ethical accountability.

🛠️ **Technologies Used:**  
- **Programming language:** Python  
- **Data Processing:** pandas, numpy, LabelEncoder, StandardScaler, joblib  
...
## 🎯 Featured Project: Sentiment Analysis of Book Reviews

Check out my Break Through Tech portfolio project on this sentiment classification project! I developed a machine learning model to analyze and classify book reviews as positive or negative, using natural language processing techniques and supervised learning. The pipeline includes data cleaning, TF-IDF vectorization, model benchmarking, and hyperparameter tuning, achieving over 80% accuracy and balanced F1-scores.

👉 Check out the full project here: [link](https://github.com/rubysmac/BTT-eCornell-Portfolio#) 
...
**Tools:**  
- Jupyter Notebook | Google Colab | Figma
...
📫 **Let’s connect!**  
I’m always open to collaboration, feedback, and new opportunities to learn and grow in tech. Feel free to reach out!
